...
# write.csv(rate_tall,"../soturon_2019/Modified_data/mushima_production.csv")
p1 = 
...
#データ保存
write_csv(rate_tall,"../soturon_2019/Modified_data/mushima_production.csv")
