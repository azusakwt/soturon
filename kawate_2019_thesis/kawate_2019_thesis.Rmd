...
( Net Ecosystem Production; NEP ) で表すことができる（ Chapin *et al*. 2018 ）。
沿岸生態系における NEPの推定は，バイオマス法を多く用いられてきた。バイオマス法は，生態系を構成する生物の成長からNEP を推定する方法である。
...
が低くなる要因とは言えない。以上のことから， 7 月に NEP
